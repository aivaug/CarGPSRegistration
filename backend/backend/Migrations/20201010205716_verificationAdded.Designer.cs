...
namespace backend.Migrations
{
    ...
    [Migration("20201010205716_verificationAdded")]
            ...
            modelBuilder.Entity("backend.Models.AccessControl.APIKey", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 10, 10, 23, 57, 15, 626, DateTimeKind.Local).AddTicks(6205),
                            IsActive = true,
                            IsDeleted = false,
                            Key = "123456789",
                            ValidTo = new DateTime(2020, 10, 15, 23, 57, 15, 626, DateTimeKind.Local).AddTicks(7231)
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 10, 10, 23, 57, 15, 622, DateTimeKind.Local).AddTicks(4262),
                            Email = "admin",
                            FirstName = "System",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("backend.Models.Vehicles.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Brand = "BMW",
                            CreatedDate = new DateTime(2020, 10, 10, 23, 57, 15, 625, DateTimeKind.Local).AddTicks(9346),
                            IsDeleted = false,
                            Model = "e90",
